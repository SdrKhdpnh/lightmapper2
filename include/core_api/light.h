...
class light_t
{
	public:
        ...
        //! Bioware specific: flag for ambients;
        virtual bool ambientLight() const { return false; }
        ...
        virtual point3d_t getPosition() { return point3d_t(0.0f, 0.0f, 0.0f); }
		virtual ~light_t() {};
		light_t(): flags(LIGHT_NONE), radius(-1.0f) {}
